              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.pop(context);
                //      GoRouter.of(context).go('/newandhot');
...
class SearchNetflixBottomSheet extends StatefulWidget {
  
  SearchNetflixBottomSheet({super.key, required this.thumbnail, required this.movie,required this.configuration});
  ...
  @override
  State<SearchNetflixBottomSheet> createState() => _SearchNetflixBottomSheetState();
}

class _SearchNetflixBottomSheetState extends State<SearchNetflixBottomSheet> {

  final NetflixBloc netflixBloc = NetflixBloc();
  @override
  void initState() {
    print(widget.movie.mediaType);
    netflixBloc.add(GetDetailsEvent(widget.movie.id.toString(),"movie",1));
    super.initState();
  }
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                Navigator.pop(context);
                GoRouter.of(context).go('/home/details', extra: {'extra': state.MovieMovieDetail,'configExtra': widget.configuration,'type': "movie"});
